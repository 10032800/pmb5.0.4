...
// +-------------------------------------------------+
// $Id: admin.php,v 1.56 2017-01-23 13:36:34 apetithomme Exp $
...
switch($categ) {
	...
	case 'instrument':
		...
		break;
	case 'ontologies' :
		$admin_layout = str_replace ( '!!menu_contextuel!!', $admin_menu_ontologies, $admin_layout );
		include("./admin/onto/main.inc.php");
		break;
	case 'loans':
	...
	case 'contribution_area':
		$admin_layout = str_replace ( '!!menu_contextuel!!', $admin_menu_contribution_area, $admin_layout );
		if ($pmb_contribution_area_activate) {
			include("./admin/contribution_area/main.inc.php");
		}
		break;
default:
		$admin_layout = str_replace('!!menu_contextuel!!', "", $admin_layout);
