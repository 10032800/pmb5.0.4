...
// +-------------------------------------------------+
// $Id: admin.tpl.php,v 1.249.2.4 2017-12-15 11:24:33 wlair Exp $
...
<ul>
	...
	<li><a href='./admin.php?categ=ontologies&sub=general'>".$msg['ontologies']."</a></li>
...
if($pmb_contribution_area_activate){
	$admin_menu_new.="<li><a href='./admin.php?categ=contribution_area'>".$msg['admin_menu_contribution_area']."</a></li>";
}
$admin_menu_new.="</ul>";
...
//$admin_menu_ontologies = création d'ontologies
$admin_menu_ontologies ="
<h1>".$msg["admin_ontologies"]." <span>> !!menu_sous_rub!!</span></h1>
<div class=\"hmenu\">
	<span".ongletSelect("categ=ontologies&sub=general").">
		<a title='".htmlentities($msg["ontologies_general"],ENT_QUOTES,$charset)."' href='./admin.php?categ=ontologies&sub=general'>
			".$msg["ontologies_general"]."
		</a>
	</span>
	!!ontologies_menu!!
</div>";
...
$admin_chklnk_form .= "</blockquote>
		...
		<div class='row'>
			<input type='checkbox' checked name='chkcp_etatcoll' value='1'>&nbsp;<label class='etiquette' >".$msg['chklnk_chk_cp_etatcoll']."</label>&nbsp;
		<blockquote>
			<input type='checkbox' name='ajtcp_etatcoll' value='1'>&nbsp;".$msg['chklnk_choix_caddie_cp_etatcoll']."
	        ";
			$requetetmpcad = "SELECT idcaddie, name FROM caddie where type='NOTI' and (autorisations='$PMBuserid' or autorisations like '$PMBuserid %' or autorisations like '% $PMBuserid %' or autorisations like '% $PMBuserid') order by name ";
$admin_chklnk_form .= gen_liste ($requetetmpcad, "idcaddie", "name", "idcaddiecp_etatcoll", "", "", "", "","","",0);
$admin_chklnk_form .= "</blockquote>
		</div>
...
$admin_menu_contribution_area ="
<h1>".$msg["admin_menu_contribution_area"]." <span>> !!menu_sous_rub!!</span></h1>
<div class=\"hmenu\">
	<span".ongletSelect("categ=contribution_area&sub=area").">
		<a title='".$msg["admin_contribution_area"]."' href='./admin.php?categ=contribution_area&sub=area'>
			".$msg["admin_contribution_area"]."
		</a>
	</span>
	<span".ongletSelect("categ=contribution_area&sub=form").">
		<a title='".$msg["admin_contribution_area_form"]."' href='./admin.php?categ=contribution_area&sub=form'>
			".$msg["admin_contribution_area_form"]."
		</a>
	</span>
	<span".ongletSelect("categ=contribution_area&sub=status").">
		<a title='".$msg["admin_contribution_area_status"]."' href='./admin.php?categ=contribution_area&sub=status'>
			".$msg["admin_contribution_area_status"]."
		</a>
	</span>
	<span".ongletSelect("categ=contribution_area&sub=equation").">
		<a title='".$msg["admin_contribution_area_equation"]."' href='./admin.php?categ=contribution_area&sub=equation'>
			".$msg["admin_contribution_area_equation"]."
		</a>
	</span>
	<span".ongletSelect("categ=contribution_area&sub=param").">
		<a title='".$msg["admin_contribution_area_param"]."' href='./admin.php?categ=contribution_area&sub=param'>
			".$msg["admin_contribution_area_param"]."
		</a>
	</span>
</div>";
...
<form class='form-$current_module' name='statusform' method=post action=\"./admin.php?categ=contribution_area&sub=status&action=update&id=!!id!!\">
<h3><span onclick='menuHide(this,event)'>!!form_title!!</span></h3>
<!--    Contenu du form    -->
<div class='form-contenu'>
<div class='row'>
<label class='etiquette' for='form_libelle'>".$msg["docnum_statut_libelle"]."</label>
		...
		<div class='row'>
			<div class='colonne5'>
				...
				<div class='row'>
				<div class='left'>
				<input class='bouton' type='button' value=' $msg[76] ' onClick=\"document.location='./admin.php?categ=contribution_area&sub=status&action='\">&nbsp;
				<input class='bouton' type='submit' value=' $msg[77] ' onClick=\"return test_form(this.form)\">
				</div>
				<div class='right'>
				!!bouton_supprimer!!
