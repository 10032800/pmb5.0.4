...
// +-------------------------------------------------+
// $Id: iimport_expl.php,v 1.76.2.1 2017-11-17 14:58:43 jpermanne Exp $
    ...
    default:
        ...
        if(!$table_list_func_import){
       	...
       	<select name=\"encodage_fic_source\" id=\"encodage_fic_source\">
			<option value=\"\" ".((!isset($encodage_fic_source) || !$encodage_fic_source) ? " selected=\"selected\" ": "").">".htmlentities($msg["admin_import_encodage_fic_source_undefine"],ENT_QUOTES,$charset)."</option>
			<option value=\"iso5426\" ".(isset($encodage_fic_source) && ($encodage_fic_source == "iso5426") ? " selected=\"selected\" ": "").">".htmlentities($msg["admin_import_encodage_fic_source_iso5426"],ENT_QUOTES,$charset)."</option>
			<option value=\"utf8\" ".(isset($encodage_fic_source) && ($encodage_fic_source == "utf8") ? " selected=\"selected\" ": "").">".htmlentities($msg["admin_import_encodage_fic_source_utf8"],ENT_QUOTES,$charset)."</option>
			<option value=\"iso8859\" ".(isset($encodage_fic_source) && ($encodage_fic_source == "iso8859") ? " selected=\"selected\" ": "").">".htmlentities($msg["admin_import_encodage_fic_source_iso8859"],ENT_QUOTES,$charset)."</option>
		</select></br></br>";
